...
import { getTenantEntitlements, getTenantProfile, getVisibleTenantsForSession } from "@/lib/data/app-data";
...
export default async function SettingsPage() {
  ...
  const [tenant, visibleTenants, entitlements] = await Promise.all([
