...
export const navItems: Array<{
  ...
  { label: "Reports", href: "/app/reports", group: "Intelligence", permission: "view_reports", icon: BarChart3 },
  { label: "Agent Portal", href: "/app/agent-portal", group: "Agent Services", permission: "view_agent_portal", icon: Landmark },
